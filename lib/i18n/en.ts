...
const en: typeof de = {
  ...
  arcade: {
    ...
    hide: "Close the game",
    intro:
      "Waiting for the next block? Drop the row when it lines up. Whatever hangs over the edge falls away.",
    startHint: "Tap or press space to start",
    dropHint: "Tap or press space to drop the row",
    paused: "Paused. Tap or press space to carry on",
    again: "Game over. Tap or press space for another round",
    score: "Score",
    height: "Height",
    best: "Personal best",
    perBlock: "{points} points per block",
    halving: "Halving: {points} points per block from here",
    over: "Over at {score} points and height {height}.",
