...
const en: typeof de = {
  ...
  holdings: {
    title: "Holding",
    back: "Back to wallets & accounts",
    walletSubtitle: "Holding, open lots and assigned addresses of this wallet.",
    accountSubtitle: "Holding, open lots and history of this account.",
    amount: "Amount",
    value: "Market value",
    costBasis: "Cost basis",
    avgCost: "Avg. cost / BTC",
    pnl: "Unrealized",
    noPrice: "Without a price there is no market value.",
    unknownBasis:
      "No acquisition price is recorded for {amount}. That amount is part of neither the cost basis nor the unrealized result.",
    unassignedGap:
      "{amount} of disposals have no lot assignment yet. Until they do, the open lots sit above the holding by exactly that amount.",
    taxFree: "Tax-free",
    taxable: "Still taxable",
    unresolved: "Not judgeable",
    unresolvedHint:
      "Origin unresolved: this amount goes into neither tax bucket, because its acquisition date would be a guess.",
    nextTaxFree: "Next lot turns tax-free on {date}",
    taxNote: "None of this is a substitute for tax advice.",
    accountsSection: "Accounts",
    accountsEmpty: "This wallet has no account yet.",
    lotsSection: "Open lots",
    lotsEmpty: "No open lots.",
    lotsAcquired: "Acquired",
    lotsCost: "Cost / BTC",
    lotsStatus: "Holding period",
    lotsSource: "Sits in",
    lotsIntro:
      "Every lot with a remaining balance, dated by the resolved original purchase rather than by any transfer in between.",
    showMore: "Show {count} more",
    addressesSection: "Addresses",
    addressesEmpty: "No address watchlist entry is assigned to this wallet yet.",
    addressesHint:
      "The assignment is a label and nothing more: watchlist and bookkeeping stay separate, neither is derived from the other.",
    addressesManage: "Open the watchlist",
    addressFindings: "{count} open findings",
    addressNoFindings: "No open findings",
    onChainSection: "Comparison with the chain",
    onChainLedger: "Book balance",
    onChainChain: "On-chain",
    onChainDiff: "Deviation",
    onChainMatch: "Book balance and chain agree.",
    onChainMismatch:
      "Book balance and chain disagree. Common causes: a transaction missing from the ledger, or an address of this wallet missing from the watchlist.",
    onChainPartial:
      "{count} assigned entries cannot be queried by address (xpub). They are absent from this comparison.",
    onChainError: "The explorer source could not be reached.",
    onChainLoading: "Loading chain data …",
    recentSection: "Recent transactions",
    recentEmpty: "No transactions yet.",
    showTransactions: "Show all transactions",
    addTransaction: "Add transaction",
    openDetail: "Open the detail view",
    lotCount: "Open lots",
    txCount: "Transactions",
    summaryAll: "Total holding",
    summaryScope: "Holding {name}",
    summaryRows: "Totals of the rows shown",
    summaryRowsHint:
      "No holding can be computed for this filter selection, so these are the totals of the rows currently shown.",
    rowsCount: "Rows",
    rowsIn: "In",
    rowsOut: "Out",
    rowsNet: "Net",
    rowsFees: "Fees",
    rowsValue: "Value",
    rowsValueHint: "{count} of {total} rows carry a EUR figure.",
    balanceBefore: "Balance without this entry",
    balanceAfter: "Balance afterwards",
    balanceSource: "Source account",
    balanceTarget: "Target account",
    balanceNegative: "This entry takes the account below zero.",
  },
  feeRepair: {
  ...
  watchlist: {
    ...
    wallet: "Wallet",
    walletNone: "Assigned to no wallet",
    walletHint:
      "A label and nothing more: it lists the entry on the wallet detail page and lets that page compare the chain against the book balance. Nothing is derived from it.",
  },
  lock: {
    title: "Locked",
    passwordPlaceholder: "Password",
