const de = {
  ...
  holdings: {
    title: "Bestand",
    back: "Zurück zu Wallets & Konten",
    walletSubtitle: "Bestand, offene Lots und zugeordnete Adressen dieses Wallets.",
    accountSubtitle: "Bestand, offene Lots und Verlauf dieses Kontos.",
    amount: "Menge",
    value: "Gegenwert",
    costBasis: "Anschaffungskosten",
    avgCost: "Ø Einstand / BTC",
    pnl: "Unrealisiert",
    noPrice: "Ohne Kurs gibt es keinen Gegenwert.",
    unknownBasis:
      "Für {amount} ist kein Einstandskurs hinterlegt. Diese Menge steckt weder in den Anschaffungskosten noch im unrealisierten Ergebnis.",
    unassignedGap:
      "{amount} an Abgängen sind noch keinem Lot zugeordnet. Solange das so ist, liegen die offenen Lots um genau diesen Betrag über dem Bestand.",
    taxFree: "Steuerfrei",
    taxable: "Noch steuerpflichtig",
    unresolved: "Nicht bewertbar",
    unresolvedHint:
      "Herkunft ungeklärt: Diese Menge wird keiner der beiden Steuerkategorien zugeschlagen, weil das Anschaffungsdatum geraten wäre.",
    nextTaxFree: "Nächstes Lot steuerfrei am {date}",
    taxNote: "Alle Steuerangaben ersetzen keine Steuerberatung.",
    accountsSection: "Konten",
    accountsEmpty: "Dieses Wallet hat noch kein Konto.",
    lotsSection: "Offene Lots",
    lotsEmpty: "Keine offenen Lots.",
    lotsAcquired: "Gekauft am",
    lotsCost: "Einstand / BTC",
    lotsStatus: "Haltefrist",
    lotsSource: "Liegt in",
    lotsIntro:
      "Jedes Lot mit Restbestand, mit dem aufgelösten Original-Kaufdatum statt dem Datum eines Übertrags.",
    showMore: "Weitere {count} anzeigen",
    addressesSection: "Adressen",
    addressesEmpty:
      "Diesem Wallet sind noch keine Einträge der Adress-Watchlist zugeordnet.",
    addressesHint:
      "Die Zuordnung ist eine reine Beschriftung: Watchlist und Buchhaltung bleiben getrennt, es wird nichts voneinander abgeleitet.",
    addressesManage: "Watchlist öffnen",
    addressFindings: "{count} offene Hinweise",
    addressNoFindings: "Keine offenen Hinweise",
    onChainSection: "Abgleich mit der Kette",
    onChainLedger: "Buchbestand",
    onChainChain: "On-Chain",
    onChainDiff: "Abweichung",
    onChainMatch: "Buchbestand und Kette stimmen überein.",
    onChainMismatch:
      "Buchbestand und Kette gehen auseinander. Typische Ursachen: eine Transaktion fehlt im Ledger, oder eine Adresse dieses Wallets fehlt in der Watchlist.",
    onChainPartial:
      "{count} zugeordnete Einträge lassen sich nicht über eine Adresse abfragen (xpub). Sie fehlen in diesem Vergleich.",
    onChainError: "Die Explorer-Quelle war nicht erreichbar.",
    onChainLoading: "Kettendaten werden geladen …",
    recentSection: "Letzte Transaktionen",
    recentEmpty: "Noch keine Transaktionen.",
    showTransactions: "Alle Transaktionen anzeigen",
    addTransaction: "Transaktion erfassen",
    openDetail: "Detailansicht öffnen",
    lotCount: "Offene Lots",
    txCount: "Transaktionen",
    summaryAll: "Bestand gesamt",
    summaryScope: "Bestand {name}",
    summaryRows: "Summe der angezeigten Zeilen",
    summaryRowsHint:
      "Für diese Filterauswahl lässt sich kein Bestand berechnen. Deshalb stehen hier die Summen der angezeigten Zeilen.",
    rowsCount: "Zeilen",
    rowsIn: "Zugang",
    rowsOut: "Abgang",
    rowsNet: "Saldo",
    rowsFees: "Gebühren",
    rowsValue: "Wert",
    rowsValueHint: "{count} von {total} Zeilen haben einen EUR-Betrag.",
    balanceBefore: "Bestand ohne diese Buchung",
    balanceAfter: "Bestand danach",
    balanceSource: "Quellkonto",
    balanceTarget: "Zielkonto",
    balanceNegative: "Diese Buchung führt das Konto ins Minus.",
  },
  feeRepair: {
  ...
  arcade: {
    ...
    hide: "Spiel schließen",
    intro:
      "Warten auf den nächsten Block? Leg die Reihe ab, wenn sie passt. Was danebenliegt, fällt weg.",
    startHint: "Tippen oder Leertaste zum Starten",
    dropHint: "Tippen oder Leertaste: Reihe ablegen",
    paused: "Pausiert. Tippen oder Leertaste zum Weiterspielen",
    again: "Vorbei. Tippen oder Leertaste für eine neue Runde",
    score: "Punkte",
    height: "Höhe",
    best: "Bestwert",
    perBlock: "{points} Punkte pro Block",
    halving: "Halving: ab jetzt {points} Punkte pro Block",
    over: "Vorbei bei {score} Punkten und Höhe {height}.",
    newBest: "Neuer Bestwert: {score} Punkte.",
  },
  celebration: {
    buyTitle: "Gestapelt.",
  ...
  watchlist: {
    ...
    wallet: "Wallet",
    walletNone: "Keinem Wallet zugeordnet",
    walletHint:
      "Nur eine Beschriftung: Sie zeigt den Eintrag auf der Wallet-Detailseite und erlaubt dort den Abgleich mit dem Buchbestand. Abgeleitet wird daraus nichts.",
  },
  lock: {
    title: "Gesperrt",
    passwordPlaceholder: "Passwort",
  ...
  pit: {
    ...
    from: "Von",
    to: "Bis",
    clearFrom: "Nur Stichtag",
    bannerPeriod:
      "Historische Ansicht: Zeitraum {from} bis {to}. Die Bewegungen beziehen sich auf diesen Zeitraum, alle übrigen Zahlen auf den {to}.",
    periodTitle: "Im Zeitraum",
    opening: "Bestand zu Beginn",
    closing: "Bestand am Ende",
    change: "Veränderung",
    boughtSold: "Gekauft {bought} · abgegangen {sold}",
    realized: "Realisiert im Zeitraum",
    realizedSplit: "Steuerpflichtig {taxable} · steuerfrei {free}",
    periodCounts: "{transactions} Transaktionen, davon {disposals} Veräußerungen",
    periodGifts: "{count} Schenkung(en) abgegangen",
    periodIncome: "{count} Zufluss/Zuflüsse als Einkünfte",
    date: "Stichtag",
